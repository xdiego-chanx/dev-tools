...
const configGet: Command = Command.builder()
    ...
    .setObserver(configCommands.getConfigProperty)
    .build();
...
const configSet: Command = Command.builder()
    ...
    .setObserver(configCommands.putConfigProperty)
    .build();
...
const configClone: Command = Command.builder()
    ...
    .setObserver(configCommands.getConfigProfile)
    .build();
...
const configOverride: Command = Command.builder()
    ...
    .setObserver(configCommands.putConfigProfile)
    .build();
...
const configExplain: Command = Command.builder()
    ...
    .setObserver(configCommands.explainConfigOptions)
    .build();
...
const typescriptClass: Command = Command.builder()
    ...
    .addArgument(new Named("flat", "Create the file in the specified path, without creating a new folder.", "-f"))
    .setObserver(typescriptCommands.createClass)
    .build();
...
const typescriptInterface: Command = Command.builder()
    ...
    .addArgument(new Positional("path", "The path where the file should be created", 0))
    .addArgument(new Named("flat", "Create the file in the specified path, without creating a new folder.", "-f"))
    .setObserver(typescriptCommands.createInterface)
    .build();
...
const typescriptEnum: Command = Command.builder()
    ...
    .addArgument(new Positional("path", "The path where the file should be created", 0))
    .addArgument(new Named("flat", "Create the file in the specified path, without creating a new folder.", "-f"))
    .setObserver(typescriptCommands.createEnum)
    .build();
...
const typescriptBarrel: Command = Command.builder()
    ...
    .addArgument(new Positional("path", "The path where the file should be created", 0))
    .addArgument(new Named("flat", "Create the file in the specified path, without creating a new folder.", "-f"))
    .setObserver(typescriptCommands.createBarrel)
    .build();
...
const nestResource: Command = Command.builder()
    ...
    .addArgument(new Named("flat", "Create all files in the specified directory, without creating a new folder", false, "-f"))
    .setObserver(nestComands.createResource)
    .build();
...
const nestModule: Command = Command.builder()
    ...
    .addArgument(new Named("flat", "Create the file in the specified directory, without creating a new folder", false, "-f"))
    .setObserver(nestComands.createModule)
    .build();
...
const nestController: Command = Command.builder()
    ...
    .addArgument(new Named("flat", "Create the file in the specified directory, without creating a new folder", false, "-f"))
    .setObserver(nestComands.createController)
    .build();
...
const nestService: Command = Command.builder()
    ...
    .addArgument(new Named("flat", "Create the file in the specified directory, without creating a new folder", false, "-f"))
    .setObserver(nestComands.createService)
    .build();
...
const nestEntity: Command = Command.builder()
    ...
    .addArgument(new Named("flat", "Create the file in the specified directory, without creating a new folder", false, "-f"))
    .addArgument(new Named("orm", "The ORM used in the project, whose syntax and modules will be used when creating the entity", "typeorm"))
    .setObserver(nestComands.createEntity)
    .build();
